    ...
    <section id="cover" class="relative bg-gradient-to-br from-[#578E7E] to-[#23272F] py-20 overflow-hidden mt-5">
        <div class="max-w-6xl mx-auto px-6 md:px-12 text-center relative z-10">
            ...
            <p class="text-lg text-white/90 max-w-2xl mx-auto">
                Berikut adalah jajaran pendiri, staff, dan tim kami yang berdedikasi dalam mengembangkan solusi teknologi inovatif untuk klien kami.
            </p>
        </div>
                ...
                <div class="bg-white rounded-3xl shadow-2xl p-8 max-w-md text-center hover:-translate-y-2 transition-all duration-300 border border-[#52a08a]/10">
                    <div class="relative mb-6">
                        <div class="w-32 h-32 bg-gradient-to-br from-[#52a08a] to-[#578E7E] rounded-full mx-auto mb-4 flex items-center justify-center">
                            <span class="text-3xl font-bold text-white">DF</span>
                        </div>

                    </div>
                    <h3 class="text-2xl font-bold text-[#23272F] mb-2">Djingga Founder</h3>
                    <p class="text-[#52a08a] font-semibold mb-4">Pendiri</p>
        ...
        <div class="max-w-6xl mx-auto px-6 md:px-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-2 transition-all duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-[#23272F] mb-2">Direktur</h3>
                    <p class="text-[#52a08a] font-semibold mb-4">Direktur</p>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Memimpin strategi bisnis dan pengembangan perusahaan dengan fokus pada pertumbuhan jangka panjang dan inovasi.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-2 transition-all duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-[#23272F] mb-2">Staff 1</h3>
                    <p class="text-[#52a08a] font-semibold mb-4">Administrasi</p>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Bertanggung jawab atas pengelolaan administrasi harian dan koordinasi antar departemen untuk kelancaran operasional.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-2 transition-all duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-[#23272F] mb-2">Staff 2</h3>
                    <p class="text-[#52a08a] font-semibold mb-4">Administrasi</p>
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Bertanggung jawab atas pengelolaan administrasi harian dan koordinasi antar departemen untuk kelancaran operasional.
                    </p>
