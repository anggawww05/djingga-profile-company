    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl md:text-3xl font-bold text-[#23272F]">Aktivitas Perusahaan</h1>
            </div>

            <form action="{{ route('project.full.search') }}" method="GET" class="w-full md:w-1/2 lg:w-1/3">
                <div class="relative">
