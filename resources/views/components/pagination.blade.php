...
@if ($paginator->hasPages())
    <div class="m-4 p-2 flex flex-col sm:flex-row items-center justify-between gap-2">
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center mt-2 sm:mt-0">
            {{-- Previous Page Link --}}
