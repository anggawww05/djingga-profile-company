        ...
        <div class="p-8">
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="title" name="title" value="Website E-commerce Fashion" required
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="5"
                        ...
                        placeholder="Jelaskan detail project, fitur utama, teknologi yang digunakan, dll.">Desain dan pengembangan website e-commerce untuk toko fashion, fitur: katalog produk, keranjang belanja, checkout, integrasi pembayaran, dan dashboard admin. Teknologi: Laravel, Tailwind CSS, MySQL.</textarea>
                ...
                <div class="mb-6">
                    ...
                    <input type="url" id="link" name="link" value="https://example.com/project"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#52a08a] focus:border-transparent transition-all duration-200"
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <label for="image"
                            ...
                            <div id="preview-container" class="w-full h-full p-4">
                                <img id="preview-image" src="/images/sample-project.jpg" alt="Preview"
                                    class="w-full h-full object-contain rounded-lg">
                            </div>
                            <div id="upload-placeholder" class="hidden flex-col items-center justify-center py-6">
